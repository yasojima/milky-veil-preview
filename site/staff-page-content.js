...
export const staffPageContent = Object.freeze({
  ...
  paragraphs: {
    "intro-copy": [
      "MILKY VEILには、おしゃれが好きで、人と話すことが好きなスタッフが集まっています。好きな髪色やファッションはそれぞれ違っても、お客様と一緒に「可愛い」を見つける時間が、みんな大好きです。",
      "スタッフ同士で新しい髪色を褒め合ったり、お客様との何気ないお話で笑ったり。そんな、自然に会話が生まれる雰囲気を大切にしています。",
      "髪を変える楽しみに、ここで過ごす楽しみも。通うたびに気軽に話せる人が増えていく、そんなお店でありたいと思っています。",
    ],
    "detail-copy": [
      "代表として、お店の自慢をひとつ挙げるなら、私は一緒に働くスタッフたちを思い浮かべます。みんな気さくで、お客様との会話を楽しみにしている人ばかりです。",
      "施術が終わっても、お互いに時間があると、話の続きが気になってこちらから声をかけに行くことも。担当のスタッフ以外とも、自然に顔なじみになっていただけたらうれしいです。",
      "もちろん、ゆっくり静かに過ごしたい日も、そのままで。お客様それぞれの心地よい距離感を大切にしています。",
      "仕上がった髪を気に入っていただくことと、ここで気持ちよく過ごしていただくこと。その両方を、スタッフみんなで大切にしているお店です。",
    ],
  },
  firstView: {
