...
export const staffPageContent = Object.freeze({
  ...
  slots: {
    ...
    "point01-lead": "私自身、髪やファッションを通じて個性をアピールするのが本当に大好きです。お客様とも共感できれば嬉しいです。",
    "point01-heading": "あなたの「これが好き」を、<br>もっと似合うかたちに。",
    "point01-body": "好きな色を選ぶこと、まあそういうのはなりたいファッションを楽しむこと、こだわりにはその人らしい魅力があると思っています。一人ひとりの「個性」に向き合うことがMILKY VEIL最大のこだわりです。",
    "card1-label": "MY STYLE",
    "card1-heading": "私だけの可愛らしさ",
    "card1-body": "髪色を変えたりいつものメイクとの組み合わせを考えたり。自分の個性がもっと伝わるデザインを探すのが大好きです。新しい髪に挑戦するときの楽しみや、少し迷う気持ちも大切にしたい。寄り添うことを第一にお客様と向き合っています。",
    "card2-label": "YOUR STYLE",
    "card2-heading": "個性は見つけるもの",
    "card2-body": "同じ写真を見ても惹かれるところは人それぞれ。一人では無理でも、一緒に探せば新しい自分を発見できちゃうかもしれません。好きな色や興味のあるデザインからちょっとずつ探していきましょう。",
    "card3-label": "OUR TEAM",
    "card3-heading": "お客様ファースト",
    "card3-body": "普段からスタッフに伝えているのは、お客様がなりたい理想像を自分事にして同じ目線になることです。技術を指導するときも、そのデザインを選んだ理由をセットで説明しています。それぞれの感性を磨きながらお客様の個性を引き出せるスタイリストでありたいと思っています。",
  },
  paragraphs: {
    "intro-copy": [
      ...
      "ここで過ごす楽しみや話せるスタッフが増えていく、そんなお店でありたいと思っています。",
    ],
    "detail-copy": [
