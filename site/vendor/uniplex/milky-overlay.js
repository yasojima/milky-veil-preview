...
mountSharedConceptMenu(document.getElementById("shared-concept-menu-root"), "/concept/");
bindSharedConceptMenu(document);

const sharedBottomScope = mountSharedBottomUi(document.getElementById("shared-bottom-ui-root"), "/concept/");
const scrollCue = mountSharedScrollCue(document.querySelector(".l-main-img__inner"), {
  target: "#concept",
  ariaLabel: "コンセプトセクションへ移動",
});
...
if (kaleidoscopeStage instanceof HTMLElement) kaleidoscopeStage.innerHTML = milkyKaleidoscopeVideoMarkup();
